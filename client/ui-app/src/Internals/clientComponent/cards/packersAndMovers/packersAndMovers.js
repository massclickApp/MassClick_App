...
const PackersAndMoversCards = () => {
    ...
    const packersAndMovers = businessList.filter(
        (b) =>
            b.category &&
    ...
    if (packersAndMovers.length === 0) {
        return (
            <div className="no-results-container">
                <p className="no-results-title">No packersAndMovers Found Yet 😔</p>
                <p className="no-results-suggestion">
                    It looks like we don't have any businesses matching "packersAndMovers"  in our data right now.
                </p>
