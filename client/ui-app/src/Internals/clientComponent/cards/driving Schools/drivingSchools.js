...
const DrivingSchoolsCards = () => {
    ...
    const drivingSchools = businessList.filter(
        (b) =>
            b.category &&
    ...
    if (drivingSchools.length === 0) {
        return (
            <div className="no-results-container">
                <p className="no-results-title">No drivingSchools Found Yet 😔</p>
                <p className="no-results-suggestion">
                    It looks like we don't have any businesses matching "drivingSchools"  in our data right now.
                </p>
