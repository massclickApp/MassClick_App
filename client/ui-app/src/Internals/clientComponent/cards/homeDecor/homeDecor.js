...
const HomeDecorCards = () => {
    ...
    const homeDecor = clientBusinessList.filter(
        (b) =>
            b.category &&
    ...
    if (homeDecor.length === 0) {
        return (
            <div className="no-results-container">
                <p className="no-results-title">No homeDecor Found Yet 😔</p>
                <p className="no-results-suggestion">
                    It looks like we don't have any businesses matching "homeDecor"  in our data right now.
                </p>
