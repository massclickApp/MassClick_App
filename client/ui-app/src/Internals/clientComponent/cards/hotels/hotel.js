...
const HotelCards = () => {
    ...
    useEffect(() => {
        dispatch(getBusinessByCategory("hotel"));
    }, [dispatch]);
    ...
    if (loading) {
        return <p className="loading-text">Loading hotels...</p>;
    }
        ...
        return (
            <div className="no-results-container">
                ...
                <p className="no-results-suggestion">
                    It looks like we don’t have any hotels or lodging services in our data right now.
                </p>
