...
const InterlockBricksCards = () => {
    ...
    const interlockBricks = businessList.filter(
        (b) =>
            b.category &&
    ...
    if (interlockBricks.length === 0) {
        return (
            <div className="no-results-container">
                <p className="no-results-title">No interlockBricks Found Yet 😔</p>
                <p className="no-results-suggestion">
                    It looks like we don't have any businesses matching "interlockBricks"  in our data right now.
                </p>
