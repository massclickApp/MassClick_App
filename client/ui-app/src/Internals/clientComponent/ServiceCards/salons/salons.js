...
const SalonsCards = () => {
    ...
    useEffect(() => {
        dispatch(getBusinessByCategory("salon"));
    }, [dispatch]);
    ...
    if (loading) {
        return <p className="loading-text">Loading salons...</p>;
    }
        ...
        return (
            <div className="no-results-container">
                ...
                <p className="no-results-suggestion">
                    It looks like we don’t have any businesses matching “salon” in our data right now.
                </p>
